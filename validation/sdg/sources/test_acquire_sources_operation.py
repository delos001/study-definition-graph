"""
Script:      test_acquire_sources_operation.py
...
Usage:       pytest validation/sdg/sources/test_acquire_sources_operation.py
                 run these checks
             pytest validation/sdg/sources/test_acquire_sources_operation.py -v
